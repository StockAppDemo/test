...
import { MONGOUSERNAME,MONGOPASSWORD,YAHOOFINANCEAPI, ALPHAVANTAGEAPI} from '../../../../../src/api/secret';
    ...
    if (a - trending.updated > 1800000){ // update trending stocks if it has been more than 24 hours since last update 86,400,000 = 1 day
        ...
        .then((response) => {return response.json()})
            .then((data) => {
                ...
                fetch(`https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=${tickers.join(',')}&interval=5min&apikey=${ALPHAVANTAGEAPI}`,
                {method:"GET"})
                .then((response) => {return response.json()})
                .then((data) => {

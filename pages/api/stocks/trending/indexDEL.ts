...
export default async function getTrendingStocks(
    ...
    console.log("getTrendingStocks api endpoint")
    ...
    var a :any = new Date
    if (a - trending.updated > 18){ // update trending stocks if it has been more than 24 hours since last update 86,400,000 = 1 day
        console.log("RUNNING UPDATE TRENDING")
        await fetch(`https://yfapi.net/v1/finance/trending/us`,{
                method:"GET",
                headers:{
            ...
            .then((data) => {
                ...
                .then((data) => {
                    ...
                    console.log("test",resData)
                            ...
                            otherCollection.updateOne({"key":"trending"},update)
                            res.status(201)
